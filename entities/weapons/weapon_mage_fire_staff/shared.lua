...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/zadkiel/empire/weapons/emp_wizard_staff.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 90), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[0] = 2} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/zadkiel/empire/weapons/emp_wizard_staff.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 0, -10), angle = Angle(0, -90, -90), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[0] = 2} }
}
...
if (CLIENT) then return end
	...
	if mana < 10 then
		...
		self.Owner:setLocalVar("mana", math.max(mana - 10, 0))
	end
	...
	local SpawnBlaserRod = ents.Create("sent_zad_firemissile")
