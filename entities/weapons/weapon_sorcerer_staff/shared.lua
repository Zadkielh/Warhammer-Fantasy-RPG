...
SWEP.PrintName = "Dark Sorcerer Staff"
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/zadkiel/chaos/weapons/chs_sorcerer_staff_1h_01_lod1.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[0] = 6} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/zadkiel/chaos/weapons/chs_sorcerer_staff_1h_01_lod1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 0, -10), angle = Angle(0, -90, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[0] = 6} }
}
...
if (CLIENT) then return end
	...
	local SpawnBlaserRod = ents.Create("sent_zad_dark_bolt")
