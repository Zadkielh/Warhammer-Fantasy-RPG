ITEM.name = "MK X Phobos Pattern - Mastercrafted Relic" -- Item Name
...
ITEM.traits = {
	hp = 4000, -- Extra HP on Spawn
	hpregen = 50, -- 5 = 5 HP per 5s 10 = 10 HP per 5s etc. 
	armorrating = 1000, -- This reduces damage. armorrating / 50 = damage reduction so 100/50 is 2 damage reduced.
	shield = 4000, -- Typical GMOD armor
    shieldregen = 75, -- Regen per 5s
...
ITEM.icon = nut.util.getMaterial("icons/armour/reiver_orange.png") -- Put the name of your icon after vgui/