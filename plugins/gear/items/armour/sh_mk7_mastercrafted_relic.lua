ITEM.name = "Aquila Pattern - Mastercrafted Relic" -- Item Name
...
ITEM.traits = {
	hp = 5000, -- Extra HP on Spawn
	hpregen = 30, -- 5 = 5 HP per 5s 10 = 10 HP per 5s etc. 
	armorrating = 1250, -- This reduces damage. armorrating / 50 = damage reduction so 100/50 is 2 damage reduced.
	shield = 5000, -- Typical GMOD armor
...
ITEM.icon = nut.util.getMaterial("icons/armour/marine_orange.png") -- Put the name of your icon after vgui/