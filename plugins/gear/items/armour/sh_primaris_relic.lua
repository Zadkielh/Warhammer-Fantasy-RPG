ITEM.name = "MK X Tacticus - Relic" -- Item Name
...
ITEM.traits = {
	...
	shield = 6000, -- Typical GMOD armor
...
ITEM.icon = nut.util.getMaterial("icons/armour/primaris_purple.png") -- Put the name of your icon after vgui/