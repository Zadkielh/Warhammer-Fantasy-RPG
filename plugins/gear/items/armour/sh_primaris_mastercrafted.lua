ITEM.name = "MK X Tacticus - Mastercrafted" -- Item Name
...
ITEM.traits = {
	hp = 6000, -- Extra HP on Spawn
	hpregen = 20, -- 5 = 5 HP per 5s 10 = 10 HP per 5s etc. 
...
ITEM.icon = nut.util.getMaterial("icons/armour/primaris_red.png") -- Put the name of your icon after vgui/