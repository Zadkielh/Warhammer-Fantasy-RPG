ITEM.name = "Aquila Pattern - Mastercrafted" -- Item Name
...
ITEM.traits = {
	...
	shield = 1500, -- Typical GMOD armor
...
ITEM.icon = nut.util.getMaterial("icons/armour/marine_red.png") -- Put the name of your icon after vgui/