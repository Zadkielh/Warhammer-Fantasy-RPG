ITEM.name = "MK X Phobos Pattern - Relic" -- Item Name
...
ITEM.icon = nut.util.getMaterial("icons/armour/reiver_purple.png") -- Put the name of your icon after vgui/