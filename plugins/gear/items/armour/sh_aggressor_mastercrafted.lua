ITEM.name = "MK X Gravis - Mastercrafted" -- Item Name
...
ITEM.traits = {
	...
	shield = 8000, -- Typical GMOD armor
    shieldregen = 40, -- Regen per 5s
...
ITEM.icon = nut.util.getMaterial("icons/armour/gravis_red.png") -- Put the name of your icon after vgui/
