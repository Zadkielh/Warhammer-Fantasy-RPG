ITEM.name = "Aquila Pattern - Relic" -- Item Name
...
ITEM.traits = {
	...
	shield = 2500, -- Typical GMOD armor
...
ITEM.icon = nut.util.getMaterial("icons/armour/marine_purple.png") -- Put the name of your icon after vgui/