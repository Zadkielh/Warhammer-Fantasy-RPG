ITEM.name = "Aquila Pattern - Standard Issue" -- Item Name
...
ITEM.traits = {
	hp = 500, -- Extra HP on Spawn
	hpregen = 5, -- 5 = 5 HP per 5s 10 = 10 HP per 5s etc. 
	armorrating = 250, -- This reduces damage. armorrating / 50 = damage reduction so 100/50 is 2 damage reduced.
	shield = 500, -- Typical GMOD armor
    shieldregen = 10, -- Regen per 5s
...
ITEM.icon = nut.util.getMaterial("icons/armour/marine_grey.png") -- Put the name of your icon after vgui/