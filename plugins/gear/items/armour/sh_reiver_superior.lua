ITEM.name = "MK X Phobos Pattern - Superior" -- Item Name
...
ITEM.traits = {
	hp = 1000, -- Extra HP on Spawn
	hpregen = 5, -- 5 = 5 HP per 5s 10 = 10 HP per 5s etc. 
	armorrating = 500, -- This reduces damage. armorrating / 50 = damage reduction so 100/50 is 2 damage reduced.
	shield = 1000, -- Typical GMOD armor
    shieldregen = 20, -- Regen per 5s
...
ITEM.icon = nut.util.getMaterial("icons/armour/reiver_blue.png") -- Put the name of your icon after vgui/