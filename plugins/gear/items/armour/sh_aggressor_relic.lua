ITEM.name = "MK X Gravis - Relic" -- Item Name
...
ITEM.traits = {
	hp = 12000, -- Extra HP on Spawn
	hpregen = 20, -- 5 = 5 HP per 5s 10 = 10 HP per 5s etc. 
	armorrating = 1750, -- This reduces damage. armorrating / 50 = damage reduction so 100/50 is 2 damage reduced.
	shield = 10000, -- Typical GMOD armor
...
ITEM.icon = nut.util.getMaterial("icons/armour/gravis_purple.png") -- Put the name of your icon after vgui/
