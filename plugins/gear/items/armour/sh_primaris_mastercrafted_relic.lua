ITEM.name = "MK X Tacticus - Mastercrafted Relic" -- Item Name
...
ITEM.traits = {
	hp = 10000, -- Extra HP on Spawn
	hpregen = 30, -- 5 = 5 HP per 5s 10 = 10 HP per 5s etc. 
	armorrating = 1500, -- This reduces damage. armorrating / 50 = damage reduction so 100/50 is 2 damage reduced.
	shield = 12000, -- Typical GMOD armor
    shieldregen = 50, -- Regen per 5s
...
ITEM.icon = nut.util.getMaterial("icons/armour/primaris_orange.png") -- Put the name of your icon after vgui/