ITEM.name = "Aquila Pattern - Superior" -- Item Name
...
ITEM.icon = nut.util.getMaterial("icons/armour/marine_blue.png") -- Put the name of your icon after vgui/