...
ENT.RadiusDamage = 5000 -- How much damage should it deal? Remember this is a radius damage, therefore it will do less damage the farther away the entity is from its enemy
...
function ENT:DeathEffects()
	...
	ParticleEffect("fantasy_warcry", self:GetPos(), self:GetAngles())
	self:EmitSound("ambient/explosions/exp2.wav", 125, 100, 1, CHAN_AUTO)
