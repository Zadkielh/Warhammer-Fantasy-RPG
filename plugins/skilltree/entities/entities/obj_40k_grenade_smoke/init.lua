...
include("shared.lua")
if (SERVER) then
	util.AddNetworkString( "createSmoke40k" )
end
/*-----------------------------------------------
...
function ENT:CustomOnInitialize()
	...
	timer.Simple(self.FussTime,function() 
...
function ENT:CustomOnThink()
	...
	if self:GetMoveType() == MOVETYPE_NONE then
		local Entities2 = ents.FindInSphere(self:GetPos(), 200)
...
function ENT:DeathEffects()
	...
	util.Effect( "40k_smoke", effectdata )
