...
ENT.RadiusDamage = 4000 -- How much damage should it deal? Remember this is a radius damage, therefore it will do less damage the farther away the entity is from its enemy
...
function ENT:CustomOnThink()
	...
	ParticleEffectAttach("plasma_bolt_small",PATTACH_POINT_FOLLOW,self.Entity,1)
end
---------------------------------------------------------------------------------------------------------------------------------------------
...
function ENT:DeathEffects()
	...
	self:EmitSound("ambient/energy/whiteflash.wav", 125, 100, 1, CHAN_AUTO)
