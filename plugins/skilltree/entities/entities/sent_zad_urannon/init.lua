...
ENT.SoundTbl_Idle = {"fx/spl/spl_shock_travel_lp.wav"}
ENT.SoundTbl_OnCollide = {"fx/spl/spl_shock_hit.wav"}
---------------------------------------------------------------------------------------------------------------------------------------------
function ENT:CustomOnInitialize()
	...
	ParticleEffectAttach("fantasy_thunderbolt_urannon", PATTACH_ABSORIGIN_FOLLOW, self, 0)
	...
	self:EmitSound("fx/spl/spl_shock_cast.wav", 75, 100, 1, CHAN_AUTO)
