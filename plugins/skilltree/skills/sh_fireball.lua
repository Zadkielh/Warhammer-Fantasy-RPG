...
SKILL.desc = [[
The Wizard hurls a large fireball, exploding when it hits something, dealing damage to anything surrounding the impact.
...
local function ability(SKILL, ply )
   local nospam = ply:GetNWBool( "nospamRanged" )
	...
	local Ent = ents.Create("sent_zad_fireball")
	...
	Ent:SetPos(ply:GetBonePosition(BoneID) + ply:GetUp()*50)
