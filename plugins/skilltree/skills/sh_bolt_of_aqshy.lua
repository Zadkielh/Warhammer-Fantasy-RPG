...
SKILL.icon = "vgui/skills/spell_fire_fireball.png"
...
SKILL.desc = [[
An armour piercing magic missile capable of blasting through multiple enemies.
...
local function ability(SKILL, ply )
   local nospam = ply:GetNWBool( "nospamRanged" )
	...
	local Ent = ents.Create("sent_zad_fireblast")
