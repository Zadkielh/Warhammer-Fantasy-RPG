SKILL.name = "Arnizipal's Dimensional Door"
...
SKILL.desc = [[
The Sorcerer opens a doorway to the realm beyond, devouring anything caught in it.
Creatures that qualify as bosses are not affected by this.
