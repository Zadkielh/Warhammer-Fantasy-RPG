...
SKILL.desc = [[
Drinking the blood of a corpse heals the caster's own wounds. The corpse must be freshly killed (dead less than an hour), or else the spell fails to work.
