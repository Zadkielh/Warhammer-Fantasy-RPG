...
SKILL.desc = [[
Bends one of the ethereal Undead to the caster's will. 
The necromancer can target any one creature with both the Ethereal and Undead traits within range, though the target may attempt to resist their command
